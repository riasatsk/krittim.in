...
<main class="flex flex-col gap-3 justify-center items-center mt-5">
	...
	<div class="flex items-center gap-3">
		<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
			...
			/></svg
		>
		<div class="font-bold text-xl">Phone: 8016676880</div>
	</div>
	<div class="flex items-center gap-3">
		<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
			><path
			...
			/><path
				fill="currentColor"
				d="M14.5 6v4.28c0 1.172.928 2.22 2.192 2.22c1.265 0 2.193-1.048 2.193-2.22V8.229c.76.205 1.56.23 2.335.067c.492.842.78 1.86.78 2.955v6.175C22 18.847 21.012 20 19.793 20H12.5v-8.75c0-2.03-.832-3.974-2.217-5.25z"
			/><path
				fill="currentColor"
				fill-rule="evenodd"
